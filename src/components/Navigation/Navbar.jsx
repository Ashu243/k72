...
const Navbar = () => {
    ...
    return (
        <div className={`${display}z-10 flex fixed top-0 w-full items-center  justify-between`} >
            <Link to="/" >
            ...
            <Link to="/navbar" className={ `relative lg:w-60 w-30 h-12 p-2 -mt-1 group overflow-hidden bg-black`}>
